# Auditoria de direitos autorais

Última revisão: 15/09/2026

## Mídias que exigem confirmação

| Recurso | Local | Situação | Ação antes da publicação |
|---|---|---|---|
...
Nenhuma faixa, vídeo, imagem ou trecho de terceiros deve permanecer em uma página monetizada sem licença, autorização ou domínio público. A música temporária do SoundCloud não deve ser tratada como trilha definitiva.

## Conteúdo original do projeto

Textos de lore, dossiês, personagens, interface, efeitos CSS e organização narrativa são conteúdo original do projeto. Mesmo assim, imagens de referência e materiais derivados precisam ser revisados individualmente.

## Checklist antes do AdSense
