(() => {
  const agents = [
    ...
    {code:'HLS-04',name:'Boby Johhn',role:'Tecnologia · Armamentos',color:'#5c82d8',skin:'#704733',image:'img-hellsing/boby-johhn.png',bio:'Especialista responsável pela infraestrutura tecnológica, comunicações protegidas e preparação de equipamentos operacionais.',tags:['Tecnologia','Comunicações','Armamentos','Suporte'],field:true},
    {code:'HLS-05',name:'Naomi',role:'Inteligência · Análise',color:'#d95d6f',skin:'#d2a07c',image:'img-hellsing/naomi.png',bio:'Agente japonesa dedicada à análise de inteligência, cruzamento de informações e leitura de padrões antes das operações.',tags:['Inteligência','Análise','Idiomas','Coordenação'],field:true},
    {code:'HLS-06',name:'Clhoe',role:'Reconhecimento · Campo',color:'#bd6ed2',skin:'#754a35',image:'img-hellsing/clhoe.png',bio:'Especialista em reconhecimento e observação avançada. Identifica ameaças, acessos e mudanças no terreno antes da entrada da equipe.',tags:['Reconhecimento','Vigilância','Campo','Precisão'],field:true},
    {code:'HLS-07',name:'Luke',role:'Rotas · Estratégia',color:'#53b68a',skin:'#68422f',image:'img-hellsing/luke.png',bio:'Especialista em mapas, rotas e deslocamento operacional. Encontra caminhos de entrada e saída onde outros enxergam bloqueios.',tags:['Mapas','Rotas','Estratégia','Armas brancas'],field:true},
    {code:'HLS-08',name:'Dimitri',role:'Intervenção · Extração',color:'#c94a3e',skin:'#c99a79',image:'img-hellsing/dimitri.png',bio:'Responsável por intervenção de alto impacto e retirada de agentes ou alvos em situações que exigem força e controle.',tags:['Intervenção','Extração','Proteção','Campo'],field:true},
    {code:'HLS-09',name:'Brian Taylor',role:'Veterano · Rastreador',color:'#b5a071',skin:'#c39372',image:'img-hellsing/brian-taylor.png',bio:'Amigo de Jack desde o FBI e o agente mais experiente da formação. Rastreia pessoas, cargas e redes através de detalhes que outros ignoram.',tags:['Rastreamento','FBI','Estratégia','Experiência'],field:true},
    {code:'HLS-10',name:'Hellen',role:'Infiltração · Disfarce',color:'#d18450',skin:'#c89470',image:'img-hellsing/hellen.png',bio:'Especialista em infiltração, identidades de cobertura e inteligência humana. Entra sem chamar atenção e sai sem deixar vínculo.',tags:['Infiltração','Disfarce','Inteligência','Combate'],field:true}
  ];
